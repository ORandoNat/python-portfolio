...
def displayBoard(board):
    ...
    board template. The list holds all of the board's tile (and empty
...
def askForPlayerMove(playerTile, board):
    ...
    Return a tuple of the (column, row)1 that the tile falls into."""
...
def isWinner(playerTile, board):
    ...
    # Go through the entire board, checking in for four-in-a-row:
