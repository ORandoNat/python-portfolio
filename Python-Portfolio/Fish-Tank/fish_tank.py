...
# We can't print to the last column on Windows without it add a
...
def generateFish():
    ...
    # Set up the colors for each character in the fish text:
...
def simulateAquarium():
    ...
    for bubbler in BUBBLERS:
        # There is a 1 in 5 change of making a bubble:
    ...
    # Iterate over BUBBLES in reverse because we are deleting from BUBBLES
...
def drawAquarium():
    ...
    print(chr(9617) * (WIDTH - 1), end='')  # Draws the sand.
