...
For example, you can draw a Hilbert Curve fractal with:
...
# A list of chr() codes is available at https://inventwithpython.com/chr
...
def getCanvasString(canvasData, cx, cy):
    ...
    """canvasData is dictionary with (x, y) tuple keys and values that
...
while True:  # Main program loop.
    ...
    print('WASD leys to move, H for help, C to clear, '
        + 'F to save, or QUIT.')
    ...
    for command in response:
        ...
        moves.append(command)  # Record this move.append
        ...
        if canvas == {}:
            if command in ('W', 'S'):
                ...
                # Make the furst line a vertical one:
