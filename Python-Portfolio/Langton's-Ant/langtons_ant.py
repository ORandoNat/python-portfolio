...
try:
    ...
    print('This program required the bext module, which you')
...
WIDTH -= 1
HEIGHT -= 1  # Adjustments for the quit message at the bottom.
...
# (!) Try changing thse colors to one of 'black', 'red', 'green',
...
def main():
    ...
    while True:  # Main program loop.
        ...
        # the simulation. Start with a copy of the current steps's board:
        ...
        for ant in ants:
            ...
            # it should wrap around the other side.
            ant['x'] = ant['x'] % WIDTH
            ant['y'] = ant['y'] % HEIGHT
