...
View this code at https://nostarch.com/big-book-small-python-project
Tags: large, artistic, game, puzzle"""

# NOTE: This program requires the sevenletterwords.txt file. You can
# find it in the main project folder for Hacking-Minigame
...
def getWords():
    ...
    # Find two more words; thses have zero matching letters.
    # We use "< 3" because the secret passwrod is already in words.
    while len(words) < 3:
...
def getComputerMemoryString(words):
    ...
    for lineNum in range(16):  # The "computer memory" has 16 lines.
        ...
        if lineNum + 16 in linesWithWords:
            # Find a radnom place in the half line to insert the word:
            insertionIndex = random.randint(0, 9)
            # Insert the word:
