...
# A dictionary whose keys are pits and values are opposite the opposite pits:
...
# Every pit label, in counter-clockwise order starting with A:
PIT_LABELS = 'ABCDEF1LKJIHG2'

# How many seedd are in each pit at the start of a new game:
...
your side and place one in each following pit, going counter-clockwise
...
def makeMove(board, playerTurn, pit):
    ...
    seedsToSow = board[pit]  # Get the number of seeds from selected pit.
